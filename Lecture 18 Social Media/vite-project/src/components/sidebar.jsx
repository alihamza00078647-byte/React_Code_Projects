...
function Sidebar({selectedTab, setSelectedTab}) {
    ...
    return (
    <>
        <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sidebar-height" style={{width: "200px"}}> 
                ...
                <ul className="nav nav-pills flex-column mb-auto"> 
                    ...
                    <li> 
                        <a href="#"  onClick={() => setSelectedTab('Create Post')}
                ...
                <ul className="dropdown-menu dropdown-menu-dark text-small shadow"> 
                    <li>
                        ...
                        </li> <li><a className="dropdown-item" href="#">Settings</a>
                        </li> 
                            <li><a className="dropdown-item" href="#">Profile</a>
                            </li> 
